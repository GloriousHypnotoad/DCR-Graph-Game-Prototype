...
{    
    ...
    public void ParseXmlFile(string resourcePath)
    {
        // Read the XML file into a string
        string xmlContent = File.ReadAllText(resourcePath);
        ...
        string resourcesFolderPath = Path.Combine(Application.dataPath, "Resources/GameData");
        if (!Directory.Exists(resourcesFolderPath))
        {
            Directory.CreateDirectory(resourcesFolderPath);
        }

        string resourcesPath = Path.Combine(resourcesFolderPath, "output.json");
